          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {WHAT_IS_INCLUDED.map((item, i) => (
              <motion.div
                ...
                className="group rounded-2xl border border-neutral-100 bg-gradient-to-br from-white to-indigo-50/30 p-5 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_40px_-20px_rgba(67,56,202,0.3)]"
              >
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-indigo-100 text-indigo-700 transition-colors group-hover:bg-indigo-600 group-hover:text-white">
        ...
        <div className="container-custom">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {SYMPTOMS.map((s) => (
              <div
                key={s}
                className="flex items-start gap-2.5 rounded-xl border border-neutral-200 bg-white p-4"
              >
                <FiCheckCircle className="mt-0.5 h-4 w-4 flex-shrink-0 text-indigo-600" />
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <SectionHeader
            ...
            className="mb-10"
          />
          <div className="rounded-2xl border border-neutral-100 bg-gradient-to-br from-indigo-50/30 to-white p-6">
            <ul className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
              {TESTS_INCLUDED.map((t) => (
